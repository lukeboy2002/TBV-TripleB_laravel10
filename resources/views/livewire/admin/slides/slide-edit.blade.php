<div class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
    <form wire:submit.prevent="save" enctype="multipart/form-data" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <x-form.input wire:model="title" type="text" name="title" id="title" :value="old('title')" required />
        ...
        <div>
            ...
            <x-form.input wire:model="image" type="file" name="image" id="image" :value="old('image')" />
            <x-form.input-error for="subtitle" class="mt-2" />
        </div>
                    ...
                    <div class="relative float-left w-full">
                        ...
                        @else
                            ...
                            <div class="block w-full h-96">
                                <img src="{{ asset('storage/'.$slide->image) }}" class="block w-full max-h-96 object-center object-cover" alt="">
                            </div>
                        @endif
